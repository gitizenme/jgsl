...
/**
 * ScriptEngineException is thrown by the ScriptEngine class to report exception conditions.
 *
 * @author zenarchitect
 * @version $Id: ScriptEngineException.java,v 1.3 2005/05/16 00:54:15 zenarchitect Exp $
 */

public class ScriptEngineException extends Throwable {
    /**
     ...
     * constructor is useful for throwables that are little more than wrappers for other throwables (for example, {@link
